...
export default function ProductPage({ params }) {
    ...
    const visibleReviews = showAllReviews
        ? product.reviews
        : product.reviews?.slice(0, REVIEWS_LIMIT);
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8" dir="rtl">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex items-center gap-3 mt-2">
                        ...
                        <button onClick={handleAddToCart} disabled={!product.inStock}
                            className={`flex-1 py-3 rounded-xl text-sm font-medium transition ${!product.inStock ? "bg-gray-200 text-gray-400 cursor-not-allowed"
            ...
            <div>
                <h2 className="text-xl font-bold mb-6">نظرات کاربران ({product.reviews?.length || 0})</h2>
                <div className="flex flex-col gap-4">
