...
export default function ProductCard({ product }) {
    ...
    return (
        <Link href={`/products/${id}`} className="group flex h-full flex-col overflow-hidden rounded-2xl bg-white shadow-sm transition hover:shadow-lg">
            ...
            <div className="flex flex-1 flex-col p-4">
                <h3 className="mb-2 line-clamp-2 min-h-[2.5rem] text-sm text-gray-800 font-medium">{title}</h3>
